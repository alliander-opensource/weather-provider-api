...
from weather_provider_api.app.routers.weather.sources.cds.client.era5sl_repository import ERA5SLRepository
from weather_provider_api.app.routers.weather.sources.cds.factors import era5sl_factors
from weather_provider_api.app.routers.weather.sources.cds.models.era5sl import ERA5SLModel
...
def test_retrieve_weather(monkeypatch, mock_dataset_era5: xr.Dataset, _get_mock_repository_dir):
    ...
    ds = era5sl_model.get_weather(coords=[GeoPosition(52.3667, 4.8945), GeoPosition(51.9851, 5.8987)],
                                  begin=one_month_ago,
                                  end=five_days_ago)
