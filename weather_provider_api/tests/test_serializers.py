...
from weather_provider_api.app.routers.weather import api_models
from weather_provider_api.app.routers.weather.api_models import ResponseFormat, WeatherContentRequestQuery
from weather_provider_api.app.routers.weather.utils.serializers import file_or_text_response, file_response
...
def test_file_or_text_response_forged_response_format(monkeypatch, mock_coordinates, mock_dataset, mock_response_query):
    ...
    with pytest.raises(NotImplementedError) as e:
        assert file_response(mock_dataset, api_models.ResponseFormat.mock_format, "knmi", "pluim",
                             mock_response_query, [mock_coordinates])
