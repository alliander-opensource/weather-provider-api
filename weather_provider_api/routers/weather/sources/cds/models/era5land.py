...
class ERA5LandModel(WeatherModelBase):
    """A weather model for the CDS ERA5 Land dataset."""

    def __init__(self):
        """Initializes the ERA5LandModel with its specific configuration and repository."""
        super().__init__()
        self.id = "era5land"
        ...
        self.version = "0.3"
        self.url = "https://cds.climate.copernicus.eu/datasets/reanalysis-era5-land?tab=overview"
