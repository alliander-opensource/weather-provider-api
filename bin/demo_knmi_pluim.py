...
from weather_provider_api.app.routers.weather.api_view_v2 import controller
from weather_provider_api.app.routers import serializers

"""
    This is a DEMO for a specific weather model: KNMI Pluim
...
if __name__ == "__main__":
    ...
    converted_weather_data = controller.convert_names_and_units(
        'knmi', 'pluim', False, ds_hist_day, OutputUnit.si
    )
    ...
    response, optional_file_path = serializers.file_or_text_response(
        converted_weather_data, response_format, 'knmi', 'pluim', ret_args, coords
    )
